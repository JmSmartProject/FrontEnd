...
class AlbaModifyPage extends StatefulWidget {
  @override
  _AlbaModifyPageState createState() => _AlbaModifyPageState();
}

class _AlbaModifyPageState extends State<AlbaModifyPage> {
